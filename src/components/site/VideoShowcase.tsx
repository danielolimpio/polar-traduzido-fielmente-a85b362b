    ...
    <div className="container relative">
      <div className="mx-auto mb-10 max-w-2xl text-center">
        ...
        <h2 className="mt-4 font-display text-4xl font-bold md:text-5xl">
          Plataforma <span className="text-gradient-primary">100% automatizada</span>
        </h2>
        <p className="mt-4 text-muted-foreground">
          Assista e descubra como nossa tecnologia de IA opera no mercado de criptomoedas em parceria com a Binance.
        </p>
      </div>
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <div className="relative rounded-[1.4rem] border border-primary/30 bg-gradient-card p-2 shadow-glow md:p-3">
          <div className="overflow-hidden rounded-[1rem] border border-border/50 bg-background">
            <video
              src="/videos/polar-tensor-intro.mp4"
              controls
              playsInline
              preload="metadata"
